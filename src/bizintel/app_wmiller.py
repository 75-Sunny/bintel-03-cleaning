...
# The three prepared data files for the smart sales project.
CUSTOMERS_FILE: Final[Path] = DATA_PREPARED / "customers_data_prepared.csv"
PRODUCTS_FILE: Final[Path] = DATA_PREPARED / "products_data_prepared.csv"
SALES_FILE: Final[Path] = DATA_PREPARED / "sales_data_prepared.csv"
